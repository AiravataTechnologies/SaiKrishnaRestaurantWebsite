      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
            About <span className="text-orange-600">Shri Krishna</span>
          </h2>
          <div className="w-24 h-1 bg-orange-600 mx-auto mb-6"></div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Experience the authentic taste of South India at Shri Krishna Restaurant. 
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Founded in 2010, Shri Krishna Restaurant has been serving authentic South Indian 
              ...
              South India with our community.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="font-bold text-gray-900">Best Restaurant</div>
                  <div className="text-sm text-gray-600">2023 Food Awards</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-center group hover:-translate-y-1 transform transition-transform"
            >
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-orange-600 group-hover:text-white transition-colors duration-300">
                {feature.icon}
              </div>
